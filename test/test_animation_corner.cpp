...
TEST(obstacleCornerAnimation6, ShouldPass)
{
  ...
  for (int i = 0; i < 2500; i++)
  {
    ...
    if (vg.getRobotGraph()[r1_desc].getPosition()(1, 0) > 64)
    {
      leaderV = Vector_t(0, 1);
    }

    if (vg.getRobotGraph()[r1_desc].getPosition()(1, 0) > 71)
    {
      leaderV = Vector_t(1, 0);
    }
...
TEST(obstacleCornerAnimation7, ShouldPass)
{
  Variables v = Variables();
  v.setParam("robots_avoidance_distance", 3.0);
  v.setParam("obstacles_avoidance_distance", 1.7);
  ...
  auto leaderV = Vector_t(sqrt(2), sqrt(2));
  boost::filesystem::create_directories("obstacleCornerAnimation7");
  ...
  for (int i = 0; i < 2500; i++)
  {
    ...
    if (i % 200 == 0)
    {
      printPlotWithArrows("obstacleCornerAnimation7/obstacleCornerAnimation7_0_90_" + std::to_string(i) + ".png",
                          "obstacleCornerAnimation7", 0, 90, 1, vg.getRobotGraph(), std::function(&overallPotential),
                          vg.getRobotGraph(), vg.getObstacleGraph(), v);
    }
  }
}

TEST(obstacleCornerAnimation8, ShouldPass)
{
  Variables v = Variables();
  v.setParam("robots_avoidance_distance", 3.0);
  v.setParam("obstacles_avoidance_distance", 1.7);
  ...
  auto leaderV = Vector_t(sqrt(2), sqrt(2));
  boost::filesystem::create_directories("obstacleCornerAnimation8");
  ...
  for (int i = 0; i < 2500; i++)
  {
    ...
    if (i % 200 == 0)
    {
      printPlotWithArrows("obstacleCornerAnimation8/obstacleCornerAnimation8_0_90_" + std::to_string(i) + ".png",
                          "obstacleCornerAnimation8", 0, 90, 1, vg.getRobotGraph(), std::function(&overallPotential),
                          vg.getRobotGraph(), vg.getObstacleGraph(), v);
    }
  }
}

TEST(obstacleCornerAnimation9, ShouldPass)
{
  Variables v = Variables();
  v.setParam("robots_avoidance_distance", 3.0);
  v.setParam("obstacles_avoidance_distance", 1.7);
  ...
  auto leaderV = Vector_t(sqrt(2), sqrt(2));
  boost::filesystem::create_directories("obstacleCornerAnimation9");
  ...
  for (int i = 0; i < 2500; i++)
  {
    ...
    if (i % 200 == 0)
    {
      printPlotWithArrows("obstacleCornerAnimation9/obstacleCornerAnimation9_0_90_" + std::to_string(i) + ".png",
                          "obstacleCornerAnimation9", 0, 90, 1, vg.getRobotGraph(), std::function(&overallPotential),
                          vg.getRobotGraph(), vg.getObstacleGraph(), v);
    }
  }
}

TEST(obstacleCornerAnimation10, ShouldPass)
{
  Variables v = Variables();
  v.setParam("robots_avoidance_distance", 3.0);
  v.setParam("obstacles_avoidance_distance", 1.7);
  ...
  auto leaderV = Vector_t(sqrt(2), sqrt(2));
  boost::filesystem::create_directories("obstacleCornerAnimation10");
...
TEST(obstacleCornerAnimation11, ShouldPass)
{
  Variables v = Variables();
  v.setParam("robots_avoidance_distance", 3.0);
  v.setParam("obstacles_avoidance_distance", 1.7);
  ...
  auto leaderV = Vector_t(sqrt(2), sqrt(2));
  boost::filesystem::create_directories("obstacleCornerAnimation11");
  ...
  for (int i = 0; i < 2500; i++)
  {
    ...
    if (i % 100 == 0)
    {
      printPlotWithArrows("obstacleCornerAnimation11/obstacleCornerAnimation11_0_90_" + std::to_string(i) + ".png",
                          "obstacleCornerAnimation11", 0, 90, 1, vg.getRobotGraph(), std::function(&overallPotential),
                          vg.getRobotGraph(), vg.getObstacleGraph(), v);
    }
  }
}

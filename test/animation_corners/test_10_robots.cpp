...
TEST(corners_10_robots_1, ShouldPass)
{
  ...
  for (int i = 0; i < 2500; i++)
  {
    ...
    if (i % 200 == 0)
    {
      printWidePlotWithArrows("corners_10_robots_1/corners_10_robots_1_" + std::to_string(i) + ".png",
...
TEST(corners_10_robots_2, ShouldPass)
{
  Variables v = Variables();
  v.setParam("robots_avoidance_distance", 3.0);
  v.setParam("obstacles_avoidance_distance", 1.7);
  ...
  auto leaderV = Vector_t(sqrt(2), sqrt(2));
  boost::filesystem::create_directories("corners_10_robots_2");
  ...
  for (int i = 0; i < 2500; i++)
  {
    ...
    if (i % 200 == 0)
    {
      printWidePlotWithArrows("corners_10_robots_2/corners_10_robots_2_" + std::to_string(i) + ".png",
                              "corners_10_robots_2", 0, 90, 1, vg.getRobotGraph(), std::function(&overallPotential),
                              vg.getRobotGraph(), vg.getObstacleGraph(), v);
    }
  }
}

TEST(corners_10_robots_3, ShouldPass)
{
  Variables v = Variables();
  v.setParam("robots_avoidance_distance", 3.0);
  v.setParam("obstacles_avoidance_distance", 1.7);
  ...
  auto leaderV = Vector_t(sqrt(2), sqrt(2));
  boost::filesystem::create_directories("corners_10_robots_3");
  ...
  for (int i = 0; i < 2500; i++)
  {
    ...
    if (i % 200 == 0)
    {
      printWidePlotWithArrows("corners_10_robots_3/corners_10_robots_3_" + std::to_string(i) + ".png",
                              "corners_10_robots_3", 0, 90, 1, vg.getRobotGraph(), std::function(&overallPotential),
                              vg.getRobotGraph(), vg.getObstacleGraph(), v);
    }
  }
}

TEST(corners_10_robots_4, ShouldPass)
{
  Variables v = Variables();
  v.setParam("robots_avoidance_distance", 3.0);
  v.setParam("obstacles_avoidance_distance", 1.7);
  ...
  auto leaderV = Vector_t(sqrt(2), sqrt(2));
  boost::filesystem::create_directories("corners_10_robots_4");
  ...
  for (int i = 0; i < 2500; i++)
  {
    ...
    if (i % 200 == 0)
    {
      printWidePlotWithArrows("corners_10_robots_4/corners_10_robots_4_" + std::to_string(i) + ".png",
                              "corners_10_robots_4", 0, 90, 1, vg.getRobotGraph(), std::function(&overallPotential),
                              vg.getRobotGraph(), vg.getObstacleGraph(), v);
    }
  }
}

TEST(corners_10_robots_5, ShouldPass)
{
  Variables v = Variables();
  v.setParam("robots_avoidance_distance", 3.0);
  v.setParam("obstacles_avoidance_distance", 1.7);
  ...
  auto leaderV = Vector_t(sqrt(2), sqrt(2));
  boost::filesystem::create_directories("corners_10_robots_5");
  ...
  for (int i = 0; i < 2300; i++)
  {
    ...
    if (i % 200 == 0)
    {
      printWidePlotWithArrows("corners_10_robots_5/corners_10_robots_5_" + std::to_string(i) + ".png",
                              "corners_10_robots_5", 0, 90, 1, vg.getRobotGraph(), std::function(&overallPotential),
                              vg.getRobotGraph(), vg.getObstacleGraph(), v);
    }
  }
}

...
TEST(isObjectInTSetTest, ShouldPass) {
    ...
    RobotGraph rg;
    Robot i(Position_t(0, 0), 0);
    Robot j(Position_t(1, 0), 1);
    Robot m(Position_t(0.5, 0.5), 2);
...
TEST(isObjectInDashedTSetTest, ShouldPass) {
    ...
    RobotGraph rg;
    Robot m(Position_t(0, 0), 0);
    Robot i(Position_t(10, 0), 1);
    Robot j(Position_t(5, 12), 2);
...
TEST(isEdgePreservedTest, ShouldPass) {
    ...
    Robot r2(Position_t(1, 0), 1);
    Robot r3(Position_t(0.5, 0.5), 2);
    Robot r4(Position_t(0.5, -0.5), 3);
    Robot r5(Position_t(-1, 0), 4);
    Robot r6(Position_t(-0.5, 0.5), 5);

...
TEST(straight_10_robots_1, ShouldPass)
{
  ...
  boost::filesystem::create_directories("straight_10_robots_1");
  ...
  for (int i = 0; i <= 1500; i++)
  {
    ...
    if (i % 200 == 0)
    {
      printPlotWithArrows("straight_10_robots_1/straight_10_robots_1_" + std::to_string(i) + ".png",
                          "straight_10_robots_1", 0, 90, 2, vg.getRobotGraph(), std::function(&overallPotential),
                          vg.getRobotGraph(), vg.getObstacleGraph(), v);
    }
  }
}

TEST(straight_10_robots_2, ShouldPass)
{
  Variables v = Variables();
  v.setParam("robots_avoidance_distance", 3.0);
  v.setParam("obstacles_avoidance_distance", 1.7);
...
TEST(straight_10_robots_3, ShouldPass)
{
  Variables v = Variables();
  v.setParam("robots_avoidance_distance", 3.0);
  v.setParam("obstacles_avoidance_distance", 1.7);
  ...
  auto leaderV = Vector_t(sqrt(2), sqrt(2));
  boost::filesystem::create_directories("straight_10_robots_3");
  ...
  for (int i = 0; i <= 1500; i++)
  {
    ...
    if (i % 200 == 0)
    {
      printPlotWithArrows("straight_10_robots_3/straight_10_robots_3_" + std::to_string(i) + ".png",
                          "straight_10_robots_3", 0, 90, 2, vg.getRobotGraph(), std::function(&overallPotential),
                          vg.getRobotGraph(), vg.getObstacleGraph(), v);
    }
  }
}

TEST(straight_10_robots_4, ShouldPass)
{
  Variables v = Variables();
  v.setParam("robots_avoidance_distance", 3.0);
  v.setParam("obstacles_avoidance_distance", 1.7);

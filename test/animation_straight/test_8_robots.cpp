...
TEST(straight_8_robots_2, ShouldPass)
{
  Variables v = Variables();
  v.setParam("robots_avoidance_distance", 3.0);
  v.setParam("obstacles_avoidance_distance", 1.7);
  ...
  auto leaderV = Vector_t(sqrt(2), sqrt(2));
  boost::filesystem::create_directories("straight_8_robots_2");
  ...
  for (int i = 0; i <= 3400; i++)
  {
    ...
    if (i % 200 == 0)
    {
      printWidePlotWithArrows("straight_8_robots_2/straight_8_robots_2_" + std::to_string(i) + ".png",
                              "straight_8_robots_2", 0, 90, 2, vg.getRobotGraph(), std::function(&overallPotential),
                              vg.getRobotGraph(), vg.getObstacleGraph(), v);
    }
  }
}

TEST(straight_8_robots_3, ShouldPass)
{
  Variables v = Variables();
  v.setParam("robots_avoidance_distance", 3.0);
  v.setParam("obstacles_avoidance_distance", 1.7);
  ...
  auto leaderV = Vector_t(sqrt(2), sqrt(2));
  boost::filesystem::create_directories("straight_8_robots_3");
  ...
  for (int i = 0; i <= 1500; i++)
  {
    ...
    if (i % 200 == 0)
    {
      printPlotWithArrows("straight_8_robots_3/straight_8_robots_3_" + std::to_string(i) + ".png",
                          "straight_8_robots_3", 0, 90, 2, vg.getRobotGraph(), std::function(&overallPotential),
                          vg.getRobotGraph(), vg.getObstacleGraph(), v);
    }
  }
}

TEST(straight_8_robots_4, ShouldPass)
{
  Variables v = Variables();
  v.setParam("robots_avoidance_distance", 3.0);
  v.setParam("obstacles_avoidance_distance", 1.7);
  ...
  auto leaderV = Vector_t(sqrt(2), sqrt(2));
  boost::filesystem::create_directories("straight_8_robots_4");
  ...
  for (int i = 0; i <= 3600; i++)
  {
    ...
    if (i % 200 == 0)
    {
      printWidePlotWithArrows("straight_8_robots_4/straight_8_robots_4_" + std::to_string(i) + ".png",
                          "straight_8_robots_4", 0, 90, 2, vg.getRobotGraph(), std::function(&overallPotential),
                          vg.getRobotGraph(), vg.getObstacleGraph(), v);
    }
  }
}
